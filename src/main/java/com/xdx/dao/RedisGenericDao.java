...
@Repository("redisGenericDao")
public class RedisGenericDao<K,V> extends
		AbstractBaseRedisDao<K, V> {
	//*************************手动存取数据********************************//
	/**
  ...
  //============================String=============================  
	...
	//================================Map================================= 
    //Map指的是redis键值对象的值为一个map,这里的item为map中的field
    /** 
     * HashGet 
     * @param key 键 不能为null 
     ...
     * @return 值 
     */  
    public Object hget(K key,Object item){  
     ...
     */  
    public boolean hset(K key,Object item,Object value) {  
         try {  
     ...
     */  
    public Long hdel(K key, Object... item){    
  ...
  //============================set=============================  
    ...
    public boolean lCleanAndSet(K key, List<V> value) {  
        try { 
