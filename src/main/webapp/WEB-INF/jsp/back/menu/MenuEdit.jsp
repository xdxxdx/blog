			...
			<form class="form-horizontal" id="thisForm">
				...
				<div class="box-body">
					<div class="form-group">
						...
						<div class="div-layer-left">
							<select name="menuType" id="menuType" class="form-control">
								<option value="1" <c:if test="${menu.menuType==1}">selected</c:if>>主菜单</option>
								<option value="2" <c:if test="${menu.menuType==2}">selected</c:if>>树菜单</option>
							</select>
						</div>
					</div>
					<input type="hidden" id="pMenuIdTmp" value="${menu.pMenuId}">
					...
					<div class="form-group">
						...
						<div class="div-layer-left">
							<input name="menuIcon" value="${menu.menuIcon}" class="form-control"
