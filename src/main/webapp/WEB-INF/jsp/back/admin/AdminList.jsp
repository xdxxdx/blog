...
<body class="hold-transition skin-red sidebar-mini"
							...
							<div class="box box-danger">
								<div class="panel-body">
									<div class="col-lg-3 col-md-3 col-sm-4 col-xs-6"
										...
										<div class="input-group">
											<div class="input-group-btn">
												<button type="button" class="btn btn-danger btn-sm">管理员账号</button>
											</div>
											<!-- /btn-group -->
											<input type="text" id="adminName" name="adminName" value="${pm.adminName}"
												class="form-control">
										</div>
									</div>
									<div class="col-lg-4 col-md-3 col-sm-4 col-xs-6"
										...
										<div class="input-group">
											<div class="input-group-btn">
												<button type="button" class="btn btn-danger btn-sm">角色</button>
											</div>
											<!-- /btn-group -->
	...
	<script src="../static/myjs/admin/admin.js"></script>
