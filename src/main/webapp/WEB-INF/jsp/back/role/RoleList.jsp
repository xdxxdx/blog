...
<body class="hold-transition skin-red sidebar-mini"
									...
									<div class="col-lg-4 col-md-3 col-sm-4 col-xs-6"
										...
										<div class="input-group">
											<div class="input-group-btn">
												<button type="button" class="btn btn-danger btn-sm">角色名称</button>
											</div>
											<!-- /btn-group -->
											<input type="text" id="roleName" name="roleName" value="${pm.roleName}"
												class="form-control">
										</div>
									</div>
	...
	<script src="../static/myjs/role/role.js"></script>
	<script type="text/html" id="xdx_bar">
	  <a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>
	  <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">删除</a>
	  <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="jurisdiction">权限</a>
	</script>
</body>
