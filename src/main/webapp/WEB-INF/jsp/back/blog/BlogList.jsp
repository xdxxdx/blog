...
<body class="hold-transition skin-red sidebar-mini"
	...
	<script>
			...
			function blogData(){
				$.ajax({
					type:"get",
					url:"./list?categoryId="+categoryId+"&tagId="+tagId+"&page="+page,
					async:true,
					datatype:'json',
					success:function(data){
						...
						for(var i in blogList){
							...
							html+='<span class="blog_edit"><a class="edit" authorId="'+blog.authorId+'" blogId="'+blog.blogId+'">编辑</a></span><span><a class="del" blogId="'+blog.blogId+'">删除</a></span><span><a class="priview" target="_blank" href="/article/'+blog.blogId+'">预览</a></span></div></div>';
