...
<body class="hold-transition skin-red sidebar-mini">
			...
			<form class="form-horizontal" id="thisForm">
				...
				<div class="box-body">
					<div class="form-group">
						<label class="control-label label-layer-left" for="tagName">标签名称</label>
						<div class="div-layer-left">
							<input id="tagName" name="tagName" value="${tag.tagName}" class="form-control"
					...
					<div class="form-group">
						...
						<div class="div-layer-left">
							<input id="priority" name="priority" value="${tag.priority}" class="form-control"
	...
	<!-- page script -->
	<script src="../static/myjs/tag/tag_add.js"></script>
</body>
