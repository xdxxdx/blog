...
<body class="hold-transition skin-red sidebar-mini">
			...
			<form class="form-horizontal" id="thisForm">
				...
				<div class="box-body">
					<div class="form-group">
						<label class="control-label label-layer-left" for="categoryName">类别名称</label>
						<div class="div-layer-left">
							<input id="categoryName" name="categoryName" value="${category.categoryName}" class="form-control"
								type="text" placeholder="请输入标签名称">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label label-layer-left" for="priority">优先级</label>
						<div class="div-layer-left">
							<input id="priority" name="priority" value="${category.priority}" class="form-control"
								type="text" placeholder="请输入优先级，数字越大越靠前">
						</div>
					</div>
				</div>
	...
	<!-- page script -->
	<script src="../static/myjs/category/category_add.js"></script>
</body>
