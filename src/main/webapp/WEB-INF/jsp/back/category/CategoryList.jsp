...
<body class="hold-transition skin-red sidebar-mini">
									...
									<div class="col-lg-4 col-md-3 col-sm-4 col-xs-6"
										...
										<div class="input-group">
											<div class="input-group-btn">
												<button type="button" class="btn btn-danger btn-sm">类别名称</button>
											</div>
											<!-- /btn-group -->
											<input type="text" id="categoryName" name="categoryName" value="${pm.categoryName}"
												class="form-control">
										</div>
									</div>
	...
	<script src="../static/myjs/category/category.js"></script>
